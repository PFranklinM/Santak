...
public class transitionEndManagerRM2R : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D coll) {
		if (coll.gameObject.tag == "player") {
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().RM2CheckpointR = true;
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().timeToFlyToCP2R = false;
