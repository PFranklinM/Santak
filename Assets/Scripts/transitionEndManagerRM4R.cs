...
public class transitionEndManagerRM4R : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D coll) {
		if (coll.gameObject.tag == "player") {
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().RM4CheckpointR = true;
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().timeToFlyToCP4R = false;
