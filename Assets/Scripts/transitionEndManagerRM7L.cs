...
public class transitionEndManagerRM7L : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D coll) {
		if (coll.gameObject.tag == "player") {
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().RM7CheckpointL = true;
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().timeToFlyToCP7L = false;
