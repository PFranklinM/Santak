...
public class transitionEndManagerRM10L : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D coll) {
		if (coll.gameObject.tag == "player") {
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().RM10CheckpointL = true;
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().timeToFlyToCP10L = false;
