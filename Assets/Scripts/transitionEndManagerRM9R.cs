...
public class transitionEndManagerRM9R : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D coll) {
		if (coll.gameObject.tag == "player") {
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().RM9CheckpointR = true;
			...
			GameObject.Find ("Player").GetComponent<playerMove> ().timeToFlyToCP9R = false;
